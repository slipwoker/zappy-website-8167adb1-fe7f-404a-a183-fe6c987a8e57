...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (animatedElements.length > 0) {
        ...
        animatedElements.forEach(function(element) {
            ...
            if (element.classList.contains('fade-in-up') || element.getAttribute('data-animate') === 'fade-in-up') {
                element.style.transform = 'translateY(30px)';
            } else if (element.classList.contains('fade-in-left') || element.getAttribute('data-animate') === 'fade-in-left') {
                element.style.transform = 'translateX(-30px)';
            } else if (element.classList.contains('fade-in-right') || element.getAttribute('data-animate') === 'fade-in-right') {
                element.style.transform = 'translateX(30px)';
            }
        ...
        style.textContent = `
            .fade-in.visible, .fade-in.animated,
            .fade-in-up.visible, .fade-in-up.animated,
            .fade-in-left.visible, .fade-in-left.animated,
            .fade-in-right.visible, .fade-in-right.animated,
            [data-animate].visible, [data-animate].animated {
                opacity: 1 !important;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8167adb1-fe7f-404a-a183-fe6c987a8e57',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8167adb1-fe7f-404a-a183-fe6c987a8e57';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8167adb1-fe7f-404a-a183-fe6c987a8e57';
